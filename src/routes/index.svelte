<svelte:head>
	<title>William Cheung</title>
	<meta data-key="description" name="description" content="Me and my website." />

	<!-- <meta property="og:image" content="https://xxx.com/images/site-image.png" />
	<meta name="twitter:image" content="https://xxx.com/images/site-image.png" /> -->
</svelte:head>

<article class="pt-16">
	<h1 class="text-5xl font-bold mb-12 text-slate-800 text-center mb-10">Hi! I'm William.</h1>
	...
	<img
		class="mx-auto mt-16 w-60 h-60 rounded-full object-cover"
		src="/images/people/william.jpg"
		alt=""
	/>
</article>
